...
public class EncapsuleTest {
	public static void main(String[] args) {
	    ...
	    Car avante = new Car("아반떼", "검정", 0);// 생성자 초기화
	    ...
	    /*
	     * 문제 2. 아래 요구사항을 충족하는 Movie 클래스를 정의하세요
	     * 
	     * <속성>
	    - title (String) : 영화 제목
	    - director (String) : 감독 이름
	    - rating (double) : 영화 평점 (0.0 ~ 10.0 사이의 길)
	    ...
	    <메서드>
	    resereSeat()
	    - 예약 가능한 좌석이 있으면 availableSeats 를 1 감소시키고 true 를 반환
	    - 예약 가능한 좌석이 없으면 false 를 반환
	    ...
	    Movie titanic = new Movie("타이타닉", "제임스카메론", 10.0);
